...
const styles = StyleSheet.create({
  card: { flex: 1, minHeight: 132, padding: Spacing.three, borderRadius: Radius.medium, borderWidth: 1, borderColor: Colors.border, backgroundColor: 'rgba(17, 40, 74, 0.66)', overflow: 'hidden' },
  ...
  label: { color: Colors.textMuted, fontFamily: Fonts.sans, fontSize: 12, marginTop: 2 },
