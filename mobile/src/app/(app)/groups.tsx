...
const styles = StyleSheet.create({
  ...
  driverButton: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 7, paddingVertical: 5, borderRadius: Radius.pill, backgroundColor: 'rgba(168,183,204,0.08)' },
  driverButtonActive: { backgroundColor: Colors.mint },
  driverText: { color: Colors.textDim, fontFamily: Fonts.rounded, fontSize: 8 },
